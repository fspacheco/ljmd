...
#SBATCH --job-name=MPI_ljmd       		# The name of your job, you'll se it in squeue.
...
#SBATCH --ntasks=4                   # Number of MPI ranks (1 for MPI serial job)
...
mpirun -np 4 ../ljmd.x < argon_2916.inp 
